...
public class BinSearchTreeWithRemove<E extends Comparable<E>>
  ...
  public Iterator<E> iterator() {
    Iterator<E> it = new Iterator<E>() {
      ...
      // private Deque<BinTreePos<E>> stack = new Deque<BinTreePos<E>>();
  ...
  public static void main(String[] args) {
    BinSearchTreeWithRemove<String> bst = new BinSearchTreeWithRemove<String>();
    String[] words = { "grape", "cranberry", "kumkwat", "vanilla", "apple", "walnut", "elderberry", "blackberry" };
    for ( String s : words ) {
    ...
    System.out.println();
    System.out.println("Removing Elderberry");
